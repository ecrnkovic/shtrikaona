...
def ecardedit(request):
    ...
    ecard.title = title if title else eacrd.title
...
def get_params(request):
    ...
    try:
        private = request.POST['private_ecard']
    except:
        private = 'no'
...
@view_config(route_name='ecarddelete', renderer ='cestitke:templates/home.jinja2')
